...
internal enum L10n {
  ...
  internal enum Url {
    /// https://github.com/logunkov/SletatRu/raw/main/JSON/booking.json
    internal static let booking = L10n.tr("Localizable", "URL.booking")
    /// https://github.com/logunkov/SletatRu/raw/main/JSON/hotel.json
    internal static let hotel = L10n.tr("Localizable", "URL.hotel")
    /// https://github.com/logunkov/SletatRu/raw/main/JSON/room.json
